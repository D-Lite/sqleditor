  ...
  <nav class="bg-white py-2 md:py-4">
    <div class="container px-4 mx-auto md:flex md:items-center">
      ...
      <div class="flex justify-between items-center">
        <a href="#" class="font-bold text-xl text-indigo-600">VueSQL</a>
      ...
      <div class="hidden md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0" id="navbar-collapse">
        ...
        <a href="#" class="p-2 lg:px-4 md:mx-2 text-indigo-600 text-center border border-transparent rounded hover:bg-indigo-100 hover:text-indigo-700 transition-colors duration-300">Editor</a>
      </div>
    </div>
  </nav>
